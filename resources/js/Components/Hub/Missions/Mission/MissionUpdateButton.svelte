...
<div class="inline-flex" on:drop={handleDrop} on:dragover={handleDragOver}>
    <label for="dropzone-file" class="items-center rounded-lg border-2 border-dashed cursor-pointer bg-gray-700 hover:bg-gray-600 border-gray-600 hover:border-gray-500">
        {#if !$form.progress}
        ...
        {:else}
            <svg class="m-1 w-4 h-4 animate-spin text-gray-400 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
